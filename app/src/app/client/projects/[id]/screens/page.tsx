...
export default function ClientScreenListPage() {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-xl font-semibold text-foreground mb-2">{t('clientScreens.loadFailed')}</h2>
  ...
  if (!project) return <p>{t('projectDetail.notFound')}</p>;
  ...
  return (
    <div>
      ...
      >
        ...
        {t('clientScreens.backToProjects')}
      </Link>
      ...
      {project.screens.length === 0 ? (
        <div className="flex flex-col items-center justify-center min-h-[40vh] text-center">
          ...
          <h2 className="text-xl font-semibold mb-2">{t('clientScreens.noScreens')}</h2>
          <p className="text-muted">{t('clientScreens.noScreensHint')}</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="border-t border-slate-100 p-4">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  {s.latest_version ? `${t('clientScreens.version')} ${s.latest_version.version}` : t('clientScreens.noVersion')}
                </p>
              </div>
            </Link>
          ))}
