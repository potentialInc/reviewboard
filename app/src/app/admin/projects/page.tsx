  ...
  return (
    <div>
                ...
                <tr key={p.id} className="group cursor-pointer hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    {p.open_feedback_count > 0 ? (
                      <span className="inline-flex items-center bg-red-100 text-red-800 rounded-full px-2.5 py-0.5 text-xs font-medium">{p.open_feedback_count} Open</span>
                    ) : (
      ...
      <DeleteConfirmModal
        ...
        message={`Are you sure you want to delete ${selected.size} project(s)? This action cannot be undone.`}
